...
# Goal : Stepper simple - check motor with conservative parameters - Full 2s
# To do : 
...
p_project = "Stepper simple using PIO - check motor with conservative parameter FULL 2S"
...
sm = StateMachine(0, prog, freq=130000, set_base=Pin(10))
# Freq -> 7.7 usec machine cycle
# Each stepp takes 32 * 7 = 224 cycles, so it takes = 1.7 mili sec
