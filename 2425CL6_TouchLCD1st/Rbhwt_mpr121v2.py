...
# Objetivo: Test hw basico de sensor tactil MPR121 i2c -> visualizacion tecla touch
# Version: 2
# Nombre : Rbhwtmpr121v2.py
...
p_project = "Test MPR121- manages same key press - raw code touch view - No IRQ"
p_version = "2.0"
