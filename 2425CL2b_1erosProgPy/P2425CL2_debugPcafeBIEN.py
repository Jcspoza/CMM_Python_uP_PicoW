...
# Nombre de programa : P2425CL2_debugPcafeBIEN
...
if precio < 2.0 : # si el precio es menor de 2 € esta barato
    print(f'El precio de {precio} € por 1/4 de Kg es BARATO')
    
elif precio >= 2.0 and precio <= 2.75: # si el precio esta entre 2 y 2.75 euros esta bien
